...
- 章末已追加"版本演化说明"小节，记录两项影响本章数据复现的底层修复：Issue `#807`（ChromaDB 默认距离从 L2 落地为 cosine）与 BM25 closet boost（PR `#788`、`#795`、`#829`）。
- 本章正文的 96.6% / 98.4% / 100% 数字**未在 v3.3.0 下重跑**，读者严格引用需以 v3.0.0 为基线理解。
